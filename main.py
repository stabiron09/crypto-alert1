...
if x:
    ...
    server.sendmail('keerak0009@gmail.com', 'arpitkeer11@gmail.com', 'bhai indiainfolline pe update as chuke hai https://www.indiainfoline.com/top-share-market-news/1')
else:
    print("sorry")
